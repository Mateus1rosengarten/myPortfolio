const projects = [
  ...
  },
  {
    ...
    text: "Green E-commerce is a sustainable marketplace developed by a team of partners, focusing on eco-friendly products. I implemented all pages from Figma designs, built authentication, created a product database with advanced search filters. The project provided hands-on experience in full-stack development and collaborative work. Although the project is currently on hold due to changes in Brazil taxation policies that affected international product sourcing, however it reflects the technical skills and problem-solving approaches I applied during its development.",
