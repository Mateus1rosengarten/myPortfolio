const projects = [
...

  {
    ...
    text: "Smart Basket is a retail technology project focused on enhancing the digital shopping experience. Initially, during the interview process, I prepared a detailed report outlining how to move the project forward and defining the next strategic steps for the frontend architecture. After that, I joined the development team as one of the frontend developers, contributing to the evolution of the interface,.",
